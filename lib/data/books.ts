...
export const BOOKS: Book[] = [
  ...
  { title: 'Turn the Ship Around!', author: 'L. David Marquet', category: 'Business', status: 'read', isFavorite: false, year: 2013, cover: '/img/books/turn_the_ship_around.jpg' },
  ...
  { title: 'The Outsiders', author: 'William N. Thorndike, Jr.', category: 'Business', status: 'reading', isFavorite: false, year: 2012, cover: '/img/books/the_outsiders.jpg' },
  ...
  { title: 'Think Faster, Talk Smarter', author: 'Matt Abrahams', category: 'Business', status: 'reading', isFavorite: false, year: 2023, cover: '/img/books/think_faster_talk_smarter.jpg' },
