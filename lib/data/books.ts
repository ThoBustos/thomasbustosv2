...
export const BOOKS: Book[] = [
  ...
  { title: 'On Writing Well', author: 'William Zinsser', category: 'Mind', status: 'reading', isFavorite: true, year: 2006, cover: '/img/books/on_writing_well.jpg' },
  ...
  { title: 'The Passions of the Soul', author: 'Rene Descartes', category: 'Philosophy', status: 'read', isFavorite: false, year: 1649, cover: '/img/books/the_passions_of_the_soul.jpg' },
  ...
  { title: 'History of Western Philosophy', author: 'Bertrand Russell', category: 'Philosophy', status: 'read', isFavorite: false, year: 1945, cover: '/img/books/history_of_western_philosophy.jpg' },
  ...
  { title: 'How Not to Be Wrong: The Hidden Maths of Everyday Life', author: 'Jordan Ellenberg', category: 'Science', status: 'reading', isFavorite: true, year: 2014, cover: '/img/books/how_not_to_be_wrong.jpg' },
  ...
  { title: 'Siddhartha', author: 'Hermann Hesse', category: 'Fiction', status: 'read', isFavorite: false, year: 1922, cover: '/img/books/siddhartha.jpg' },
